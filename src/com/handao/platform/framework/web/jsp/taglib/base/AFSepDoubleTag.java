...
public class AFSepDoubleTag extends com.handao.platform.framework.web.jsp.taglib.base.AFBaseHandlerTag {
    ...
    public int doStartTag() throws JspException {
        ...
        if(null != this.getPrecision() && !"".equalsIgnoreCase(this.getPrecision())) {
            objStringBuffer.append("validNumber_sep(this,'" + this.colSize + "','" +
                                   this.colPrecision + "');");
        }
        //进行区间校验,最大最小值校验
        if("true".equalsIgnoreCase(this.validate)) {
            ...
            if(null != this.getMax() && null != this.getMin()) {
                ...
                objStringBuffer.append("validNumber3(this,'" + "NiN" + "','" +
                                       this.getMinexp() + "','" + this.getMax() + "','" +
                                       this.getMaxexp() + "','true')");
