...
<script language="javascript" src="<%=ctx%>/platform/jsp/sm/privilege/user/UserAuthorizationList.js"></script>
...
<input type="hidden" name="whereToBack" value="userAuthorization">
...
<%--   	<handao:headButton name="变更记录" accesskey="C" onClick="userLongRecord();"/>--%>
   	<handao:headButton name="角色分配" accesskey="A" onClick="manageRole();"/>
