...
<script language="javascript" src="<%=ctx%>/platform/jsp/sm/privilege/role/RoleDefineList.js"></script>
...
<handao:headLink titleKey="common.sm.privilege.role.role_define.title" bundle="<%=bundleKey%>">
	...
	<input type=button id="createButton" class=tb_Button style="CURSOR: hand" value="增加(N)" accesskey="N" onClick="createRecord();">
	<input type=button id="modifyButton" class=tb_Button style="CURSOR: hand" value="修改(E)" accesskey="E" onClick="modifyRecord();">
	<input type=button id="viewButton" class=tb_Button style="CURSOR: hand" value="查看(V)" accesskey="V" onClick="viewRecord();">
	<input type=button id="moduleButton" class=tb_Button style="CURSOR: hand" value="功能权限(M)" accesskey="M" onClick="manageModule();">
	<input type=button id="deleteButton" class=tb_Button style="CURSOR: hand" value="删除(D)" accesskey="D" onClick="deleteRecord();">
