...
<html>
	...
	function onNodeSelect(node)
	{
	    ...
	    param+="chk="+currentDirID;
	    document.getElementById('currentDirID').value=currentDirID;
	    document.getElementById('currentLevel').value=node.attributes['level'];	    
	    document.getElementById('editArea').src = "<%=ctx%>/md/directory/direaut/Direaut.do?method=doEditIni&doWhat=edit&"+param;
	}
	</script>
	</head>
		...
		<table border="0" class=listTable width="100%" cellpadding="0" cellspacing="0" height="100%">
			<tr width="100%">
				...
				<td width="80%" height="100%">
					<iframe align="left" width="100%" height="100%" name ='editArea' src="<%=ctx%>/md/directory/direaut/Direaut.do?method=doEditIni&doWhat=edit&chk=1">   </iframe>
				</td>
			</tr>
		</table>
